...
function Hero() {
  return (
    ...
    <p className="max-w-130 mt-2 text-sm md:text-base">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio maxime sequi ex quo. Debitis eum non tenetur iure dicta, recusandae voluptates natus architecto alias totam consequatur illo error cumque sunt.</p>
